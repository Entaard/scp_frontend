              ...
              <div className="table-row">
                ...
                <div className="qty qty-changer">
                  <fieldset>
                    ...
                    <input type="text" className="qty-input" value="2" data-min="0" data-max="5"/>
                    <input type="button" value="+" className="increase"/>
                  </fieldset>
                </div>
                <div className="subtotal">
                  $85.00
                ...
                <div className="remove">
                  <a href="#" className="icon icon-close-2"></a>
                </div>
              </div>
              <div className="table-row">
                <div className="photo">
                ...
                <div className="qty qty-changer">
                  <fieldset>
                    <input type="button" value="&#8210;" className="decrease"/>
                    <input type="text" className="qty-input" value="2" data-min="0"/>
                    <input type="button" value="+" className="increase"/>
                  </fieldset>
                </div>
                <div className="subtotal">
            ...
            <div className="row">
                ...
                <form className="white" action="#">
                  ...
                  <div className="select-wrapper">
                    <select className="form-control">
                      ...
                      <option data-code="IO" value="British Indian Ocean Territory">British Indian Ocean Territory
                      </option>
                      ...
                      <option data-code="HM" value="Heard Island And Mcdonald Islands">Heard &amp; McDonald Islands
                      </option>
              ...
              <div className="col-sm-6 col-md-4">
                ...
                <form className="white" action="#">
                  ...
                  <input type="text" className="form-control dashed"/>
                  <div>
